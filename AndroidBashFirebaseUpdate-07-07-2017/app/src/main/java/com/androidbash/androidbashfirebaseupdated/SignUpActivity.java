...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Firebase mRef = new Firebase("https://login-multiple.firebaseio.com/");
    private User user;
...
//       updateUI(currentUser);
    ...
    public void onSignUpClicked(View view) {
        createNewAccount(name.getText().toString(),phoneNumber.getText().toString(),email.getText().toString(), password.getText().toString());
